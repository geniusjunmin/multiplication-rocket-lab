/**
 * Bilingual i18n Unit Tests (tests/test-i18n.js) - Version 4.0.0
 */
describe("7. Internationalization & Bilingual Support (I18nManager 4.0)", () => {
  ...
  it("7.1 Should support switching between English and Chinese", () => {
    ...
    Assert.equal(window.i18n.t("appTitle"), "Multiplication Rocket Lab 4.0 🚀", "English title should match");

    window.i18n.setLanguage("zh");
    Assert.equal(window.i18n.currentLanguage, "zh", "Current language should be zh");
    Assert.equal(window.i18n.t("appTitle"), "乘法火箭实验室 4.0 🚀", "Chinese title should match");
  });
