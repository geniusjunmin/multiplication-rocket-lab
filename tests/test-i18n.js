/**
 * Bilingual i18n Unit Tests (tests/test-i18n.js)
 */
describe("7. Internationalization & Bilingual Support (I18nManager)", () => {
  ...
  it("7.1 Should support switching between English and Chinese", () => {
    ...
    Assert.equal(window.i18n.t("appTitle"), "Multiplication Rocket Lab 🚀", "English title should match");

    window.i18n.setLanguage("zh");
    Assert.equal(window.i18n.currentLanguage, "zh", "Current language should be zh");
    Assert.equal(window.i18n.t("appTitle"), "乘法火箭实验室 🚀", "Chinese title should match");
  });
